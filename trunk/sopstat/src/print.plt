...
set output sprintf("%s/%s/n_peers_dw.svg",dir,name)
...
set output sprintf("%s/%s/data_and_video_downloaded.svg",dir,name)
...
set output sprintf("%s/%s/packet_size.svg",dir,name)
...
set output sprintf("%s/%s/packet_size_up.svg",dir,name)
...
set output sprintf("%s/%s/packet_size_dw.svg",dir,name)
